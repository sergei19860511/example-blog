    ...
    <div class="container">
        <div class="header-inner flex items-center justify-between lg:justify-start">
            ...
            <div class="header-actions flex items-center gap-3 md:gap-5 z-[9999]">
                @auth('web')
                    <a href="{{ route('logout') }}" class="profile hidden xs:flex items-center">
                        ...
                        <span class="profile-text relative ml-2 text-white text-xxs md:text-xs font-bold">Выйти {{ auth('web')->user()->name }}</span>
                    </a>
                @endauth
